        ...
        ?>
            ...
            ?>
                ...
                <tr style="text-align: center;">
                    ...
                    <td><button t onclick="document.location='cetak.php?id_barang=<?php echo base64_encode(($row['id_barang'])) ?>'">Cetak</button><button t onclick="document.location='edit.php?stok=<?php echo base64_encode(($row['stok'])) ?>'">Edit</button>
                    </td>
                </tr>
